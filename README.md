...
### 1️⃣ Shared Action Space for Human–Robot Collaboration  
- **Overview:**  
...
- **Impact:**  
  Enhances adaptive human–robot interaction, paving the way for robots that generalize actions and can request demonstrations when needed.

---

### 2️⃣ Swarm Robotics for Collaborative Autonomous Mapping  
- **Overview:**  
...
### 3️⃣ VoxFormer: Transformer-based Semantic Scene Completion for Autonomous Vehicles  
- **Overview:**  
  Designed a model to reconstruct occluded scenes using camera-only inputs—a critical capability for autonomous driving perception.
- **Technical Details:**  
  - **Architecture:** Combines a sparse voxel transformer (ViT) with occupancy grid mapping to intelligently fill in occluded areas.  
  - **Scene Reconstruction:** Employs Bird’s Eye View (BEV) projections to enhance detection of pedestrians, vehicles, and obstacles.  
...
### 4️⃣ Expressive Robot Hand – AI-driven Human–Robot Interaction  
- **Overview:**  
...
### 5️⃣ 6-DOF Trajectory Optimization for Industrial Robotic Arms  
- **Overview:**  
...
### 6️⃣ AR-VR Pass-through and Virtual Reality Environment  
- **Overview:**  
